...
<script>$(function(){$('img').attr('onerror', '').on('error', function(){if (!$(this).data('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('http://wx.diouy.cn/attachment/') == -1 ? this.src.replace('http://aliyundsaliyun.oss-cn-hongkong.aliyuncs.com/', 'http://wx.diouy.cn/attachment/') : this.src.replace('http://wx.diouy.cn/attachment/', 'http://aliyundsaliyun.oss-cn-hongkong.aliyuncs.com/');$(this).data('check-src', true);}});});</script></body>
</html>
