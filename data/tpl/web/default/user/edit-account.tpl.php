...
<div id="js-user-edit-account" ng-controller="UserEditAccount" ng-cloak>
	...
	<table class="table we7-table table-hover">
		...
		<tr ng-repeat="webapp in phoneapps" ng-if="phoneapps">
			...
			<td>
				<div class="link-group">
					<a ng-href="./index.php?c=account&a=post&do=base&uniacid={{phoneapp.uniacid}}&acid={{phoneapp.acid}}&account_type=<?php echo ACCOUNT_TYPE_PHONEAPP_NORMAL;?>" class="color-default">PC设置</a>
					<a ng-href="./index.php?c=account&a=post-user&do=edit&uniacid={{phoneapp.uniacid}}&acid={{phoneapp.acid}}&account_type=<?php echo ACCOUNT_TYPE_PHONEAPP_NORMAL;?>" class="color-default">操作员设置</a>
				</div>
			</td>
		</tr>
		<tr ng-if="!webapps">
	...
	<table class="table we7-table table-hover">
		...
		<col width="240px"/>
		<tr>
			<th colspan="2" class="text-left">可使用的熊掌号</th>
			<th>角色</th>
			<th class="text-right">操作</th>
		</tr>
		<tr ng-repeat="xzapp in xzapps" ng-if="xzapps">
			<td class="text-left"><img ng-src="{{xzapp.thumb}}" class="img-responsive"/></td>
			<td class="text-left">
				<p ng-bind="xzapp.name"></p>
				<span class="color-gray">类型：
					<span>PC</span>
				</span>
			</td>
			<td>
				<span ng-if="xzapp.role == 'founder'">创始人</span>
				<span ng-if="xzapp.role == 'owner'">主管理员</span>
				<span ng-if="xzapp.role == 'manager'">管理员</span>
				<span ng-if="xzapp.role == 'operator'">操作员</span>
				<span ng-if="xzapp.role == 'clerk'">店员</span>
			</td>
			<td>
				<div class="link-group">
					<a ng-href="./index.php?c=account&a=post&do=base&uniacid={{xzapp.uniacid}}&acid={{xzapp.acid}}&account_type=<?php echo ACCOUNT_TYPE_XZAPP_NORMAL;?>" class="color-default">熊掌号设置</a>
					<a ng-href="./index.php?c=account&a=post-user&do=edit&uniacid={{xzapp.uniacid}}&acid={{xzapp.acid}}&account_type=<?php echo ACCOUNT_TYPE_XZAPP_NORMAL;?>" class="color-default">操作员设置</a>
				</div>
			</td>
		</tr>
		<tr ng-if="!webapps">
